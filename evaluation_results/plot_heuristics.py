...
def main():
        ...
        bpi2012_deviations_mean=bpi2012_deviations.loc[(bpi2012_deviations["delta"]==chosen_delta) & (bpi2012_deviations["alpha"]==chosen_alpha) & (bpi2012_deviations["epsilon"]==chosen_epsilon)]
        bpi2012_deviations_mean=bpi2012_deviations_mean["time"].mean()

        bpi2012_nonaligning_all=bpi2012_deviationsApprox.loc[(bpi2012_deviationsApprox["delta"]==chosen_delta) & (bpi2012_deviationsApprox["alpha"]==chosen_alpha) & (bpi2012_deviationsApprox["epsilon"]==chosen_epsilon) &(bpi2012_deviationsApprox["approximationMode"]=="NONALIGNING_ALL")]
        bpi2012_nonaligning_known=bpi2012_deviationsApprox.loc[(bpi2012_deviationsApprox["delta"]==chosen_delta) & (bpi2012_deviationsApprox["alpha"]==chosen_alpha) & (bpi2012_deviationsApprox["epsilon"]==chosen_epsilon)& (bpi2012_deviationsApprox["approximationMode"]=="NONALIGNING_KNOWN")]
        bpi2012_prefixsuffix=bpi2012_prefixsuffix.loc[(bpi2012_prefixsuffix["delta"]==chosen_delta) & (bpi2012_prefixsuffix["alpha"]==chosen_alpha) & (bpi2012_prefixsuffix["epsilon"]==chosen_epsilon) &(bpi2012_prefixsuffix["approximationMode"]=="PREFIXSUFFIX")]
        ...
        for i in range (0,3):
                ...
                nonaligning_known=bpi2012_nonaligning_known.loc[bpi2012_nonaligning_known["k"]==float(k_nonaligning_list[i])]
        ...
        #f.show()
        f.savefig("./approximation_comparison_time.pdf", bbox_inches='tight')
        ...
        for i in range (0,3):
                ...
                print(((nonaligning_all["approxThenCalc"].values)/nonaligning_all["approximated"].values).mean())

                nonaligning_known=bpi2012_nonaligning_known.loc[bpi2012_nonaligning_known["k"]==float(k_nonaligning_list[i])]
                nonaligning_known_list.append(((nonaligning_known["approximated"].values)/nonaligning_known["variants"].values))
                print(((nonaligning_known["approxThenCalc"].values)/nonaligning_known["approximated"].values).mean())

                                            
                prefixsuffix=bpi2012_prefixsuffix.loc[bpi2012_prefixsuffix["k"]==float(k_prefixsuffix_list[i])]
                prefixsuffix_list.append(((prefixsuffix["approximated"].values)/prefixsuffix["variants"].values))
                print(((prefixsuffix["approxThenCalc"].values)/prefixsuffix["approximated"].values).mean())
        ...
        f.show()
        f.savefig("./approximation_comparison_approximated_variants.pdf", bbox_inches='tight')
