...
#fitness with approximation
        ...
        k_fitness_list=[]
        for i in range (0,3):
                bpi2012_delta=bpi2012approx.loc[(bpi2012approx["delta"]==float(delta_list[i])) & (bpi2012approx["alpha"]==chosen_alpha) & (bpi2012approx["epsilon"]==chosen_epsilon) & (bpi2012approx["k"]==chosen_k)]
                ...
                bpi2012_alpha=bpi2012approx.loc[(bpi2012approx["delta"]==chosen_delta) & (bpi2012approx["alpha"]==float(alpha_list[i])) & (bpi2012approx["epsilon"]==chosen_epsilon) & (bpi2012approx["k"]==chosen_k)]
                ...
                bpi2012_epsilon=bpi2012approx.loc[(bpi2012approx["delta"]==chosen_delta) & (bpi2012approx["alpha"]==chosen_alpha) & (bpi2012approx["epsilon"]==float(epsilon_list[i])) & (bpi2012approx["k"]==chosen_k)]
                ...
                bpi2012_k=bpi2012approx.loc[(bpi2012approx["delta"]==chosen_delta) & (bpi2012approx["alpha"]==chosen_alpha) & (bpi2012approx["epsilon"]==chosen_epsilon) & (bpi2012approx["k"]==float(k_list[i]))]
        ...
        for i in range(len(alpha_trace_list)):
            alpha_trace_list[i] = alpha_trace_list[i] / 13087
        for i in range(len(epsilon_trace_list)):
            epsilon_trace_list[i] = epsilon_trace_list[i] / 13087
        for i in range(len(delta_trace_list)):
            delta_trace_list[i] = delta_trace_list[i] / 13087
        for i in range(len(k_trace_list)):
            k_trace_list[i] = k_trace_list[i] / 13087
...
#for runtime
        ...
        #f.show()
        f.savefig("./bpi2012_param_time_Approx_k"+str(chosen_k)+".pdf", bbox_inches='tight')

#for log size
        f, (ax1, ax2, ax3, ax4) = plt.subplots(1, 4, sharey=True)
        ax1.set_ylabel('Sampled traces', fontsize=18)
        ax1.set_yscale('log')
        ax1.set_ylim(0.0007, 1.3)
        ...
        ax4.set_xticklabels(k_list, rotation='vertical', fontsize=14)
        #f.show()
        f.savefig("./bpi2012_param_traces_Approx_k"+str(chosen_k)+".pdf", bbox_inches='tight')
...
#for Fitness
        ...
        #f.show()
        f.savefig("./bpi2012_param_fitness_Approx_k"+str(chosen_k)+".pdf", bbox_inches='tight')
...
#fitness w/o approximation
        ...
        k_fitness_list=[]
        for i in range (0,3):
                bpi2012_delta=bpi2012.loc[(bpi2012["delta"]==float(delta_list[i])) & (bpi2012["alpha"]==chosen_alpha) & (bpi2012["epsilon"]==chosen_epsilon)]
                delta_time_list.append(bpi2012_delta["time"].values)
                delta_trace_list.append(bpi2012_delta["logSize"].values)
                delta_fitness_list.append(bpi2012_delta["fitness"].values)

                bpi2012_alpha=bpi2012.loc[(bpi2012["delta"]==chosen_delta) & (bpi2012["alpha"]==float(alpha_list[i])) & (bpi2012["epsilon"]==chosen_epsilon)]
                alpha_time_list.append(bpi2012_alpha["time"].values)
                alpha_trace_list.append(bpi2012_alpha["logSize"].values)
                alpha_fitness_list.append(bpi2012_alpha["fitness"].values)

                bpi2012_epsilon=bpi2012.loc[(bpi2012["delta"]==chosen_delta) & (bpi2012["alpha"]==chosen_alpha) & (bpi2012["epsilon"]==float(epsilon_list[i]))]
                epsilon_time_list.append(bpi2012_epsilon["time"].values)
                epsilon_trace_list.append(bpi2012_epsilon["logSize"].values)
                epsilon_fitness_list.append(bpi2012_epsilon["fitness"].values)

                bpi2012_k=bpi2012.loc[(bpi2012["delta"]==chosen_delta) & (bpi2012["alpha"]==chosen_alpha) & (bpi2012["epsilon"]==chosen_epsilon)]
                k_time_list.append(bpi2012_k["time"].values)
                k_trace_list.append(bpi2012_k["logSize"].values)
                k_fitness_list.append(bpi2012_k["fitness"].values)
