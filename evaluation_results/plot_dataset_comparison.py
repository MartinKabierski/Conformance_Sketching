...
def main():
        ...
        bpi2014_deviations=bpi2014_deviations.loc[(bpi2014_deviations["delta"]==chosen_delta) & (bpi2014_deviations["alpha"]==chosen_alpha) & (bpi2014_deviations["epsilon"]==chosen_epsilon)]
        ...
        road_traffic_deviations=road_traffic_deviations.loc[(road_traffic_deviations["delta"]==chosen_delta) & (road_traffic_deviations["alpha"]==chosen_alpha) & (road_traffic_deviations["epsilon"]==chosen_epsilon)]
        road_traffic_deviationsApprox=road_traffic_deviationsApprox.loc[(road_traffic_deviationsApprox["delta"]==chosen_delta) & (road_traffic_deviationsApprox["alpha"]==chosen_alpha) & (road_traffic_deviationsApprox["epsilon"]==chosen_epsilon) & (road_traffic_deviationsApprox["k"]==chosen_k) & (road_traffic_deviationsApprox["approximationMode"]=="NONALIGNING_KNOWN")]
...
#plot computing time comparisons
        ...
        #print(bpi2012_deviationsApprox.head())
        #print(bpi2012_orig_mean)
        #print(bpi2012_fitness["time"].values)
        #print(bpi2012_list)
        ...
        #f.show()
        f.savefig("./computing_time.pdf", bbox_inches='tight')
       # while True:
        #        pass
        print(statistics.mean(bpi2012_fitness["time"].values/bpi2012_orig_mean))
        print(statistics.mean(bpi2012_fitnessApprox["time"].values/bpi2012_orig_mean))

        #print(statistics.mean(bpi2014_fitness["time"].values/bpi2014_orig_mean))
       #print(statistics.mean(bpi2014_fitnessApprox["time"].values/bpi2014_orig_mean))

        #print(statistics.mean(road_traffic_fitness["time"].values/road_traffic_orig_mean))
...
#plot sampled trace comparisons
        ...
        print(statistics.mean(bpi2014_fitness["logSize"].values))
        print(statistics.mean(bpi2014_fitness["variants"].values))

        print(statistics.mean(bpi2014_fitness["logSize"].values)/bpi2014_orig_mean)
        ...
        #f.show()
        f.savefig("./traces.pdf", bbox_inches='tight')
