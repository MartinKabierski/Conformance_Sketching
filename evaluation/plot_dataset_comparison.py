...
def main():
    ...
    # BPI 2012#
    bpi2012_baseline = pd.read_csv("./src/BPI_Challenge_2012_baseline.csv", sep=';')
    bpi2012_fitness = pd.read_csv("./src/BPI_Challenge_2012_fitness.csv", sep=';')
    bpi2012_fitnessApprox = pd.read_csv("./src/BPI_Challenge_2012_fitnessApprox.csv", sep=';')
    bpi2012_deviations = pd.read_csv("./src/BPI_Challenge_2012_deviations.csv", sep=';')
    bpi2012_deviationsApprox = pd.read_csv("./src/BPI_Challenge_2012_deviationsApprox.csv", sep=';')
    ...
    # BPI 2014#
    bpi2014_baseline = pd.read_csv("./src/Detail_Incident_Activity_baseline.csv", sep=';')
    bpi2014_fitness = pd.read_csv("./src/Detail_Incident_Activity_fitness.csv", sep=';')
    bpi2014_fitnessApprox = pd.read_csv("./src/Detail_Incident_Activity_fitnessApprox.csv", sep=';')
    bpi2014_deviations = pd.read_csv("./src/Detail_Incident_Activity_deviations.csv", sep=';')
    bpi2014_deviationsApprox = pd.read_csv("./src/Detail_Incident_Activity_deviationsApprox.csv", sep=';')
    ...
    # road traffic fines
    road_traffic_baseline = pd.read_csv("./src/Road_Traffic_Fines_Management_Process_baseline.csv",
                                        sep=';')
    road_traffic_fitness = pd.read_csv("./src/Road_Traffic_Fines_Management_Process_fitness.csv", sep=';')
    road_traffic_fitnessApprox = pd.read_csv(
        "./src/Road_Traffic_Fines_Management_Process_fitnessApprox.csv", sep=';')
    road_traffic_deviations = pd.read_csv("./src/Road_Traffic_Fines_Management_Process_deviations.csv",
                                          sep=';')
    road_traffic_deviationsApprox = pd.read_csv(
        "./src/Road_Traffic_Fines_Management_Process_deviationsApprox.csv", sep=';')
    ...
    rdRTF_baseline = pd.read_csv("./src/RTFM_model2_baseline.csv",
                                        sep=';')
    rdRTF_fitness = pd.read_csv("./src/RTFM_model2_fitness.csv", sep=';')
    rdRTF_fitnessApprox = pd.read_csv(
        "./src/RTFM_model2_fitnessApprox.csv", sep=';')
    rdRTF_deviations = pd.read_csv("./src/RTFM_model2_deviations.csv",
                                          sep=';')
    rdRTF_deviationsApprox = pd.read_csv(
        "./src/RTFM_model2_deviationsApprox.csv", sep=';')
