...
def main():
        ...
        #original
        pra_baseline=pd.read_csv("./src/prAm6_baseline.csv", sep=';')
        prb_baseline=pd.read_csv("./src/prBm6_baseline.csv", sep=';')
        prc_baseline=pd.read_csv("./src/prCm6_baseline.csv", sep=';')
        prd_baseline=pd.read_csv("./src/prDm6_baseline.csv", sep=';')
        pre_baseline=pd.read_csv("./src/prEm6_baseline.csv", sep=';')
        prf_baseline=pd.read_csv("./src/prFm6_baseline.csv", sep=';')
        prg_baseline=pd.read_csv("./src/prGm6_baseline.csv", sep=';')

        #fitness
        pra_synthetic=pd.read_csv("./src/prAm6_synthetic.csv", sep=';')
        prb_synthetic=pd.read_csv("./src/prBm6_synthetic.csv", sep=';')
        prc_synthetic=pd.read_csv("./src/prCm6_synthetic.csv", sep=';')
        prd_synthetic=pd.read_csv("./src/prDm6_synthetic.csv", sep=';')
        pre_synthetic=pd.read_csv("./src/prEm6_synthetic.csv", sep=';')
        prf_synthetic=pd.read_csv("./src/prFm6_synthetic.csv", sep=';')
        prg_synthetic=pd.read_csv("./src/prGm6_synthetic.csv", sep=';')
