...
public class BinomialConfidenceCalculator {
	...
	//TODO add Jeffreys Interval
	public enum MethodType {
		CLOPPER_PEARSON, AGRESTI_COULL, WILSON_SCORE, NORMAL_APPROXIMATION, RULE_OF_THREE
	}
	...
	private ConfidenceInterval computeConfidence(TestParams p) {
		...
		if (method == MethodType.RULE_OF_THREE) {
			return new ConfidenceInterval(0,(-Math.log(1-confidenceLevel)/p.trails),confidenceLevel);
		}
		return null;
	}
